			...
			<div class="flex flex-direction-col flex-gap-large" in:fly={{ y: -20, duration: 600 }}>
				<div class="flex flex-between-horizontal flex-center-vertical w-100">
					...
					<div class="flex flex-gap-regular">
						...
						<a href="/super-admin/nup/tambah-nup" class="no-decor"><button class="btn-fill flex flex-center-vertical flex-gap-small"><img src="/images/icons/Add_Plus.svg"> <span>Tambah NUP</span></button></a>
					</div>
				</div>
