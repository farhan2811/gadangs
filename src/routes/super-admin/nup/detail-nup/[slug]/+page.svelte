					...
					<div class="w-60 flex flex-direction-col flex-gap-large">
						<div class="flex flex-gap-regular">
							<div class="w-50 flex flex-direction-col flex-gap-small">
								<div class="main-title-card-detail">{nup.perumahan}</div>
						...
						<div class="flex flex-gap-regular">
							<div class="w-50 flex flex-direction-col flex-gap-regular">
								...
								<div class="flex flex-direction-col">
									...
									<div class="content-card-detail">{nup.pilihan_unit.tanggal_submit}</div>
								</div>
								<div class="flex w-100">
									<div class="flex flex-direction-col w-50">
										<div class="caption-card-detail">Harga Unit</div>
										<div class="content-card-detail">Rp. {nup.pilihan_unit.harga_unit}</div>
									</div>
									<div class="flex flex-direction-col">
										<div class="caption-card-detail">Versi Price List</div>
										<div class="content-card-detail">{nup.versi_pricelist}</div>
									</div>
								</div>
								<div class="flex flex-direction-col flex-gap-semi-small">
									...
									<div class="data-perum-detail flex flex-direction-col flex-gap-regular">
										...
										<div class="flex flex-direction-col">
											...
											<div class="content-card-detail">{nup.pilihan_unit.jenis_bangunan}</div>
										</div>
										<div class="flex w-100">
											<div class="flex flex-direction-col w-50">
												<div class="caption-card-detail">Blok</div>
												<div class="content-card-detail">{nup.pilihan_unit.tower_blok}</div>
											</div>
											<div class="flex flex-direction-col">
												<div class="caption-card-detail">Nomor</div>
												<div class="content-card-detail">{nup.pilihan_unit.nomor}</div>
											</div>
										</div>
										<div class="flex w-100">
											<div class="flex flex-direction-col w-50">
												<div class="caption-card-detail">Lantai</div>
												<div class="content-card-detail">{nup.pilihan_unit.lantai} Lantai</div>
											</div>
											<div class="flex flex-direction-col">
												<div class="caption-card-detail">Tipe</div>
												<div class="content-card-detail">{nup.pilihan_unit.tipe_perumahan}</div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="w-50 flex flex-direction-col flex-gap-regular">
								...
								<div class="flex flex-direction-col">
									...
									<div class="content-card-detail">{nup.lead_marketing}</div>
								</div>
								<div class="flex flex-direction-col">
									<div class="caption-card-detail">Marketing</div>
									<div class="content-card-detail">{nup.marketing}</div>
								</div>
